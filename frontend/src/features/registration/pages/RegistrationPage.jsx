          ...
          <tbody>
            {patients.map((p) => (
              ...
              >
                ...
                <td>{p.phone}</td>
                <td>
                  <span className="badge badge--primary">{p.testType}</span>
                </td>
                <td className="td-muted">
          ...
          <div className="modal profile-modal">
            ...
            <div className="profile-body">
              <div className="profile-header-info">
                <div className="profile-avatar">{viewPatient.name[0]}</div>
                <div>
                  <h3 className="profile-name">{viewPatient.name}</h3>
