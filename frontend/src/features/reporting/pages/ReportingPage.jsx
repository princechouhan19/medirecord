  ...
  return (
    <div className="reporting-page">
          ...
          <tbody>
            {reports.map((r) => (
              <tr key={r._id}>
                ...
                <td>
                  <span className="badge badge--primary">{r.reportType}</span>
                </td>
                <td>{r.diagnosis}</td>
      ...
      <div className="mobile-only-list">
        {reports.map((r) => (
          ...
          >
            <div className="patient-card__header">
              ...
              <div style={{ flex: 1 }}>
                <div className="td-name">{r.patient?.name}</div>
        ...
        {reports.length === 0 && (
          <div className="card empty-row">No reports yet</div>
        )}
      </div>
            ...
            <form onSubmit={handleSubmit} className="modal__form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  placeholder="e.g. Normal CBC results"
                />
              </div>
              <div className="form-group">
        ...
        >
          <div className="modal report-view">
            ...
            <div className="report-view__body">
              <div className="report-view__row">
                <label>Type</label>
              ...
              <div className="report-view__row">
                <label>Diagnosis</label>
                <span>{viewReport.diagnosis}</span>
              </div>
              {viewReport.findings && (
                <div className="report-view__row">
                  <label>Findings</label>
                  <span>{viewReport.findings}</span>
                </div>
              )}
              <div className="report-view__row">
                <label>Date</label>
                <span>
                  {new Date(viewReport.createdAt).toLocaleDateString("en-IN")}
                </span>
              </div>
            </div>
          </div>
