      ...
      <div className="auth-card">
        ...
        <div className="auth-card__left" ref={leftRef}>
          <div className="auth-card__left-content">
            ...
            <div className="auth-features">
              {[
                {
                  text: "Generate diagnostic reports with auto-filled patient data",
                  badge: "NEW",
                },
                {
                ...
                <div className="auth-feature" key={i}>
                  ...
                  <div>
                    <span>{f.text}</span>
                    {f.badge && (
                      <span className="auth-feature__badge">{f.badge}</span>
                    )}
                  </div>
                </div>
              ))}
            ...
            <div className="auth-card__left-doctor">
              <img src="/doctor.svg" alt="Doctor" className="doctor-image" />
            </div>
          </div>
        ...
        <div className="auth-card__right" ref={rightRef}>
          ...
          <p className="auth-copy">
            MediRecord © 2024 — Built for modern clinics
          </p>
        </div>
      </div>
    </div>
