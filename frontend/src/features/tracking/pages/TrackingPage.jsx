...
export default function TrackingPage() {
  ...
  const handleAddVisit = async (id) => {
    await api.post(`/tracking/${id}/visit`, {
      date: visitDate,
      notes: visitNote,
    });
    setVisitModal(null);
    ...
    <div className="tracking-page">
      ...
      <div className="tracking-grid">
        {trackings.map((t) => (
          <div
            key={t._id}
            className={`tracking-card card ${t.status === "Overdue" ? "tracking-card--overdue" : ""}`}
          >
            <div className="tracking-card__header">
              ...
              <span
                className={`badge badge--${t.status === "Overdue" ? "danger" : "success"}`}
              >
                {t.status}
              </span>
            </div>
            ...
            <div className="tracking-card__next">
              Next visit:{" "}
              <strong className={t.status === "Overdue" ? "text-danger" : ""}>
            ...
            <form onSubmit={handleCreate} className="modal__form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  placeholder="e.g. Routine prenatal sonography"
                />
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, nextVisit: e.target.value })
                  }
                  required
                />
              </div>
      ...
      {visitModal && (
        <div
          className="modal-overlay"
          onClick={(e) => e.target === e.currentTarget && setVisitModal(null)}
        >
          <div className="modal">
            <div className="modal__header">
            ...
            <div className="modal__form">
              ...
              <div className="modal__footer">
                ...
                <button
                  className="btn btn--primary"
                  onClick={() => handleAddVisit(visitModal._id)}
                >
                  Save Visit
                </button>
              </div>
